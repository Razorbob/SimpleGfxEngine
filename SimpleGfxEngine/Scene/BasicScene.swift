...
class BasicScene: Scene{
    ...
    override init(device: MTLDevice){
        self.t1 = Triangle(device: device, color: SIMD4<Float>(0,1,0,1)) // Green
        ...
        self.t1.translate(direction: SIMD3<Float>(0,0,-6))
        self.t1.scale(axis: SIMD3<Float>(repeating: 0.8))
        
        self.t2.translate(direction: SIMD3<Float>(-2,0,-10))
        self.t2.scale(axis: SIMD3<Float>(repeating: 0.9))
